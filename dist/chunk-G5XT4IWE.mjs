...
function generateKeys(items, resolvedKeys) {
  return items.map(
    (item, index) => generateKey(item, index, resolvedKeys == null ? void 0 : resolvedKeys[index])
  );
}
...
export { SafeEvalError, UnregisteredActionError, __commonJS, __objRest, __spreadProps, __spreadValues, __toESM, analyzeNode, analyzeTree, createBoundHandler, createBoundServerActionHandler, generateKey, generateKeys, isActionBinding, isExpression, isStaticNode, renderNode, resolveExpression, resolveHandler, resolveProps, safeEval, validateRegistry };
//# sourceMappingURL=chunk-G5XT4IWE.mjs.map
//# sourceMappingURL=chunk-G5XT4IWE.mjs.map